export const apps = [
    {
        title: 'Otto',
        summary: 'Shopify App that helps users automate the changing of graphics in their Shopify store. Built using React, Node JS, Firebase and Serverless Cloud Functions.',
        link: 'https://apps.shopify.com/otto',
        primaryColor: '#6474B7'
    },
    {
        title: 'Fresh Phrase',
