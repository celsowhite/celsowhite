        ...
        <main class="page_container">
            ...
            <div class="website_content_container">
                <ul class="tab_items website_nav">
                    <li data-title="fullmoon">Fullmoon Festival</li>
                    <li data-title="tribeca">Tribeca Fillm</li>
                    <li data-title="lusa">NPR's Latino USA</li>
                    <li data-title="matte">MATTE</li>
                    <li data-title="twt">The Water Trust</li>
                    <li data-title="trago">Trago</li>
                    <li data-title="abtn">PBS's America By The Numbers</li>
                </ul>
                <div class="tab_content website_content">
                    ...
                    <div id="trago">
                        <p>In preparation for the launch of their product, Trago needed a custom ecommerce shop to promote and sell the Water Cap. I developed the site.
