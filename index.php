        ...
        <main class="page_container homepage">
            ...
            <section class="website_images_carousel">
                ...
                <a class="website_container website_link" data-website="matte" href="http://matteprojects.com" target="_blank" style="background-image: url('img/websites/matte_header.jpg');">
                    ...
                    <div class="website_screen_container">
                        <div class="website_screen">
                            <video muted playsinline loop data-src="video/matte.mp4"></video>
                 ...
                 <a class="website_container website_link" data-website="forto" href="https://fortocoffee.com" target="_blank" style="background-image: url('img/websites/forto_header.jpg');">
                    ...
                    <div class="website_screen_container">
                        <div class="website_screen">
                            <video muted playsinline loop data-src="video/forto.mp4"></video>
                ...
                <a class="website_container website_link" data-website="nyss" href="https://nyss.org" target="_blank" style="background-image: url('img/websites/nyss_header.jpg'); background-position: center;">
                    ...
                    <div class="website_screen_container">
                        <div class="website_screen">
                            <video muted playsinline loop data-src="video/nyss.mp4"></video>
                            <img class="static_screen" src="img/websites/nyss_screen.png" />
                        </div>
                    </div>
                </a>
                <a class="website_container website_link" data-website="fullmoon" href="http://fullmoonfest.com" target="_blank" style="background-image: url('img/websites/fullmoon2017_header.jpg'); background-position: 98% center;">
                ...
                <a class="website_container website_link" data-website="mas" href="https://musicandstrategy.com" target="_blank" style="background-image: url('img/websites/mas_header.jpg'); background-position: 98% center;">
                    <div class="color_overlay" style="background-color: rgba(0,0,0,.3);"></div>
                    <div class="website_screen_container">
                        <div class="website_screen">
                            <video muted playsinline loop data-src="video/mas.mp4"></video>
                            <img class="static_screen" src="img/websites/mas_screen.png" />
                        </div>
                    </div>
                </a>
                <a class="website_container website_link" data-website="tribeca" href="http://tribecafilm.com" target="_blank" style="background-image: url('img/websites/tribeca_header.jpg'); background-position: center">
                    <div class="color_overlay" style="background-color: rgba(180,112,53,.3);"></div>
                    <div class="website_screen_container">
                        <div class="website_screen">
                            <video muted playsinline loop data-src="video/tribeca.mp4"></video>
                ...
                <a class="website_container website_link" data-website="lusa" href="http://latinousa.org" target="_blank" style="background-image: url('img/websites/latino_usa_header.jpg'); background-position: left center;">
                    ...
                    <div class="website_screen_container">
                        <div class="website_screen">
                            <video muted playsinline loop data-src="video/latinousa.mp4"></video>
